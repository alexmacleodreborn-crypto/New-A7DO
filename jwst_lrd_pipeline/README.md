...
1. **Fetch public data** from MAST for a candidate LRD list.
2. **Select targets** with broad Balmer lines and compact morphologies.
3. **Fit line profiles** using Doppler-only vs Doppler+scattering models and compare evidence.
...
3. Run the selection step to identify viable spectra:
...
4. Fit Doppler-only vs Doppler+scattering models:
